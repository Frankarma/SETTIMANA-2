...
console.log("Array Vuoto Creato");
...
let i = 0; // Le variabili si dichiarano sempre fuori nel ciclo while.
let crewMass = 0;

while (i < starWarsCharacters.length) {
  let memberMass = starWarsCharacters[i].mass;
  crewMass = crewMass + memberMass;
